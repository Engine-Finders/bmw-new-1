...
function ComparisonCard({ item, isDark }) {
  return (
    <article
      className={`relative overflow-hidden rounded-xl border shadow-[0_12px_32px_rgba(10,26,43,0.08)] ${
    ...
    >
      ...
      <div className="grid md:grid-cols-[minmax(260px,0.98fr)_minmax(280px,1fr)]">
        ...
        <div className="flex min-w-0 flex-col p-4 md:p-5">
          ...
          <p className={`mt-4 text-[0.83rem] leading-[1.5] md:mt-3 md:text-[0.9rem] ${isDark ? "text-white/78" : "text-[#172b4a]"}`}>{item.preview}</p>
    ...
    <section className={`relative overflow-hidden px-3 py-7 md:py-8 ${isDark ? "bg-[#02070b]" : "bg-white"}`}>
      ...
      <div className="relative mx-auto w-full max-w-8xl">
        <div className="max-w-[720px] pt-1 md:pt-9">
          ...
          <p className={`mt-4 max-w-[690px] text-[0.88rem] leading-[1.55] md:text-[1.02rem] ${isDark ? "text-white/82" : "text-[#172b4a]"}`}>{data.subHeadline}</p>
        </div>
